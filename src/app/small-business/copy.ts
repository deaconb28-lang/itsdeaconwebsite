...
export const OFFERINGS: Offerings = offeringsFor({
  refresh: {
    ...
    blurb:
      ...
      "calls. Same site, same address, working properly by the end of the week.",
    features: [
      "What you do, your service area, and your phone number correct and easy to find",
      ...
      "Click to call, quote requests, and map links actually wired up",
