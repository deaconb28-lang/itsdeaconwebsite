 ...
 * and compares three names side by side. The headline says exactly what the
 * picture shows: two of the three look alive, and the third has no reviews, no
 * hours, and the sentence the template shipped with.
 */
